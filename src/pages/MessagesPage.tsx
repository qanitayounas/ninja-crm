  ...
  return (
    <div className="flex flex-col h-[calc(100vh-140px)] gap-4 md:gap-6 antialiased relative">
      ...
      <div className="flex flex-1 gap-4 md:gap-6 min-h-0">
        {/* Column 1: Chat List */}
        <Card className={cn(
          "w-full lg:w-80 p-0 flex flex-col overflow-hidden transition-all duration-300",
      ...
      <Card className={cn(
        "w-80 flex flex-col items-center p-8 overflow-y-auto custom-scrollbar transition-all duration-300",
        ...
        {activeChat ? (
          <>
            ...
            <Avatar name={activeChat.contactName} className="h-20 w-20 md:h-24 md:w-24 text-2xl mb-4" />
